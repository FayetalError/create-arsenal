...
public final class ArsenalAxeItem extends AxeItem implements ArsenalGeoItem {
    ...
    /** Creates an axe with optional looping GeckoLib animation data. */
    public ArsenalAxeItem(Tier tier, Properties properties, String modelPath, String animationPath) {
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        if (idleAnimation != null) {
            controllers.add(new AnimationController<>(this, "axe_idle", 0, state -> {
