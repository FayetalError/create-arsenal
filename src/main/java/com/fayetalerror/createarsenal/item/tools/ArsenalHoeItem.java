...
public final class ArsenalHoeItem extends HoeItem implements ArsenalGeoItem {
    ...
    /** Creates a hoe with optional looping GeckoLib animation data. */
    public ArsenalHoeItem(Tier tier, Properties properties, String modelPath, String animationPath) {
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        if (idleAnimation != null) {
            controllers.add(new AnimationController<>(this, "hoe_idle", 0, state -> {
