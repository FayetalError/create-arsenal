...
import com.fayetalerror.createarsenal.client.renderer.item.tools.AndesitePickaxeRenderer;
 ...
 */
public final class AndesitePickaxeItem extends PickaxeItem implements GeoItem {
    /** Stores animation state for individual item stacks. */
    private final AnimatableInstanceCache animationCache = GeckoLibUtil.createInstanceCache(this);

    /**
     * Creates an andesite pickaxe with the supplied mining tier and item properties.
     *
     ...
     */
    public AndesitePickaxeItem(Tier tier, Properties properties) {
    ...
    public void createGeoRenderer(Consumer<GeoRenderProvider> consumer) {
        consumer.accept(new GeoRenderProvider() {
            private AndesitePickaxeRenderer renderer;

            @Override
            public BlockEntityWithoutLevelRenderer getGeoItemRenderer() {
                if (this.renderer == null) {
                    this.renderer = new AndesitePickaxeRenderer();
                }
