...
/** Generic GeckoLib-backed intermediate item selected by a definition model path. */
public final class ArsenalCoreItem extends Item implements GeoItem {
    private final String modelPath;
    private final AnimatableInstanceCache animationCache = GeckoLibUtil.createInstanceCache(this);

    public ArsenalCoreItem(String modelPath, Properties properties) {
        super(properties);
